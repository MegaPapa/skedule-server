...
-- -----------------------------------------------------
-- Table `skedule-app`.`company_invite`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `skedule-app`.`company_invite` (
  `mongo_user_id` INT NOT NULL,
  `company_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `skedule-app`.`multistep_task`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `skedule-app`.`multistep_task` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(255) NOT NULL,
  `description` LONGTEXT NULL,
  `isCompleted` TINYINT(1) NOT NULL DEFAULT 0,
...
-- -----------------------------------------------------
-- Table `skedule-app`.`task_step`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `skedule-app`.`task_step` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `description` LONGTEXT NULL,
  `endTime` DATETIME NULL,
  ...
  CONSTRAINT `fk_task_step_multistep_task1`
    ...
    REFERENCES `skedule-app`.`multistep_task` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
